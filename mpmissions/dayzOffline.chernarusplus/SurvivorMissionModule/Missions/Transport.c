class TransportMission extends SurvivorMissions
{
	...
	{		
		...
		m_MissionMessage1 = SurvivorName + ", хлопець, який працював на мене, розповів, що він схрестив особливий сорт конопель із різних рослин 'Cannabis ruderalis'. Мені це потрібно для експериментів над зараженими. Він сказав, що удобрював рослини подрібненими зараженими.";  
		m_MissionMessage2 = "Я думаю, він мав на увазі будь-який ферментований напій із водою, попелом заражених і шматками плоті, змішаними на кухонному міксері. Вплив на ріст і цвітіння рослин був колосальним. Також здається, що це містить речовину, відмінну від природних канабіноїдів. Я хочу виділити цю речовину, щоб побачити, як вона діє на заражених.";  
