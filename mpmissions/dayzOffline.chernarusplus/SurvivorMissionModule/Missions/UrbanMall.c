...
{	//UrbanMall is a copy of CityMall mission, it has equal functionality but uses different MissionBuilding 
	...
	{		
		...
		//Mission informant
		m_MissionInformant = "Олена Петрівна";
		...
		m_MissionMessage1 = "Пані " + SurvivorName + ", вчителька молодших класів, розповіла мені, що вона врятувала декількох дітей зі свого класу від їхніх заражених родин. Я пообіцяла їй допомогти з пошуком їжі та інших медичних припасів для дітей.";  
		m_MissionMessage2 = "Учора я дізналася, що торговий центр у місті\n** " + m_MissionLocation + " **\nзабарикадований і, ймовірно, всередині є їжа. Але там було занадто багато заражених, і я не змогла перевірити супермаркет.";  
		m_MissionMessage3 = "Їй терміново потрібні наступні речі:\n- " + ReqFoodAmount + " консервів\n- " + ReqMedAmount + " пакунків антибіотиків\nБудь ласка, допоможи мені забезпечити пані " + SurvivorName + " цими життєво необхідними речами для дітей. Будь обережний!";  
		...
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "11.24 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "9.98 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "8.72 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "7.46 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "6.2 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "4.94 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "3.68 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "2.42 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "1.16 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-0.1 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-1.36 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-2.62 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-3.88 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-5.14 -0.05 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-6.4 -0.05 5.97" - Offset , "0 90 0"));
		...
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "11.24 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "9.98 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "8.72 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "7.46 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "6.2 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "4.94 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "3.68 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "2.42 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "1.16 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-0.1 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-1.36 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-2.62 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-3.88 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-5.14 1.21 5.97" - Offset , "0 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-6.4 1.21 5.97" - Offset , "0 90 0"));
		//shopwindow small 
		...
		//shop entrance		
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-10.436 -0.602 4.070" - Offset , "90 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-10.436 -0.602 2.810" - Offset , "90 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-10.236 -0.602 1.560" - Offset , "75 85 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-10.436 0.658 4.070" - Offset , "90 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-10.436 0.658 2.810" - Offset , "90 90 0"));
		Barricades.Insert( new Param3<string,vector,vector>("WoodenPlank", "-10.236 0.658 1.560" - Offset , "75 95 0"));
